...
import { BsMegaphone } from "react-icons/bs"; // Announcement icon
import { FaChartLine } from "react-icons/fa"; // Analytics icon
...
export default function CourseStatus() {
  return (
    <div id="wd-course-status" style={{ width: "300px" }}>
      ...
      <button className="btn btn-lg btn-secondary w-100 mt-1 text-start">
        <FaChartLine className="me-2 fs-5" /> View Courses Stream
      </button>
    </div>
  );
}
